...
//
//  The new fastparse library has broken the approach taken
//  here of adding simultaneously a bunch of strings.
//
//   https://github.com/lihaoyi/fastparse/pull/204
//
//  Have to either find a workaround or else rewrite the
//  parser somehow.

// package net.opetopic.ui.latex
